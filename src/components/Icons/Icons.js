...
const Icons = () => (
  <div className="social-icons animate-icons">
    ...
    <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/story/dondevo">
      <i className="fab fa-stack-overflow" />
    </a>
    <a target="_blank" rel="noopener noreferrer" href="https://medium.com/@dondevo">
      <i className="fab fa-medium" />
    </a>
    <a className="devto" target="_blank" rel="noopener noreferrer" href="https://dev.to/dondevo">
